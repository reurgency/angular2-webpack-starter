# Angular2 Webpack2.2 Bootstrap4 Starter

Based on the superb AngularClass starter, this starter includes:
* Bootstrap 4 
* SASS integration to allow complete Bootstrap customization
* jQuery 3
* Ng2-bootstrap 1.3
* Web Fonts (Open Sans)
* Font Awesome 4.7
